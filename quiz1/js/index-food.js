...
document.addEventListener('click', (e) => {
    if (!sotoBetawiModalBox.contains(e.target) && !mainNav.contains(e.target) && !sotoBetawiModalButton.contains(e.target) && !navbarLogo.contains(e.target)) {
        sotoBetawiModal.style.display = 'none';
        e.preventDefault();
    }
});
...
document.addEventListener('click', (e) => {
    if (!kerakTelorModalBox.contains(e.target) && !mainNav.contains(e.target) && !kerakTelorModalButton.contains(e.target) && !navbarLogo.contains(e.target)) {
        kerakTelorModal.style.display = 'none';
        e.preventDefault();
    }
});
...
document.addEventListener('click', (e) => {
    if (!nasiUdukModalBox.contains(e.target) && !mainNav.contains(e.target) && !nasiUdukModalButton.contains(e.target) && !navbarLogo.contains(e.target)) {
        nasiUdukModal.style.display = 'none';
        e.preventDefault();
    }
});
...
document.addEventListener('click', (e) => {
    if (!gadoGadoModalBox.contains(e.target) && !mainNav.contains(e.target) && !gadoGadoModalButton.contains(e.target) && !navbarLogo.contains(e.target)) {
        gadoGadoModal.style.display = 'none';
        e.preventDefault();
    }
});
